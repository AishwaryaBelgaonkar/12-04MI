...
<div class="ex2">
	...
	<h1 align="center"
			...
			<h1 style="font-family:Mistral;color:#c79559; font-size:60px;margin-top:30px;margin-left:-280px;">Come HUNGRY....<br/><br/> </h1>
<h1 style="font-family:Mistral;color:#c79559; font-size:60px;margin-top:20px;margin-left:190px;"> leave HAPPY!!!</h1>
		...
		<form action="Payment.jsp">
					<input type="submit" value="Online Payment" class="button button1" style="margin-left:-100px;margin-top:10px;" />
				</form>
				<form action="FeedBack.html">
					<input type="submit" value="Payment by Cash" class="button button1" style="margin-left:-700px;margin-top:-50px;" />
				</form>
